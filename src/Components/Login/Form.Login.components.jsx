...
function Form() {
    return (
        <>
            <section className='bg-white px-10 pb-20 rounded-3xl border-2 w-full mx-10'>
                <div>
                ...
                <form className='mt-10'>
                    <div>
                        ...
                        <input
                            className='focus:outline-none focus:border-rose-500 w-full border-2 text-lg border-amber-500 rounded-full p-4 mt-1 h-20 font-judson'
